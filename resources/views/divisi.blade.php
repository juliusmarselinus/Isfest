...
<body class="bg-[#0a101d] text-slate-200 min-h-screen flex items-center justify-center">
  <div class="text-center space-y-4">
    <h1 class="text-4xl font-black text-white">Halaman <span style="background:linear-gradient(90deg,#ffec1f,#f59e0b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">Divisi</span></h1>
